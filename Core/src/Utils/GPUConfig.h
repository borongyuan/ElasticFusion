...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["Xavier"] = std::pair<int, int>(128, 48);
            rgbStepMap["Xavier"] = std::pair<int, int>(128, 48);
            rgbResMap["Xavier"] = std::pair<int, int>(192, 512);
            so3StepMap["Xavier"] = std::pair<int, int>(80, 48);
